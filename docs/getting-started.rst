...
This getting started guide helps you to properly connect the `DC Motor Control Shield with BTN9970LV and BTN9990LV`__ with the right platform and teaches you how to install the required software to use the Infineon 
BTN99x0 chips.
...
3. **Install the library**. In the Arduino IDE, go to the menu *Sketch > Include library > Library Manager*. Type *BTN99x0* in the search bar and install the *arduino-BTN99x0* library.
...
Now you can attach the power supply to the X1 connector. You have to attach your load to the desired output channel in the X2 connector. The brushed DC motor need to be connected between the outputs OUT1 and OUT2 of both half bridges BTN9970 and BTN9990.
