...
EXAMPLES=(BTN99x0/enable_disable_pwm_one_chip/enable_disable_pwm_one_chip.ino \
          ...
          BTN99x0_shield/enable_disable_pwm_one_chip/enable_disable_pwm_one_chip.ino \
          BTN99x0_shield/error_shield/error_shield.ino \
          BTN99x0_shield/loadcurrent_pwm_slewrate_one_chip/loadcurrent_pwm_slewrate_one_chip.ino \
